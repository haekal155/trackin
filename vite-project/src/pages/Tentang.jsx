      ...
      <div className='bg-white mb-14'>
          ...
          <div className="relative flex items-center w-full h-full overflow-x-scroll scroll whitespace-nowrap scroll-smooth">
              ...
              <div className="bg-fifth-color p-4 rounded-lg shadow-md mr-6 ml-6">
                ...
                <p className="text-gray-600">Kemampuan untuk menambahkan, menghapus,</p>
                <p className="text-gray-600">dan memperbarui informasi produk dengan mudah</p>
              </div>
              ...
              <div className="bg-fifth-color p-4 rounded-lg shadow-md mr-6">
                ...
                <p className="list-disc list-inside text-gray-600">Memantau penjualan harian, mingguan, dan</p>
              ...
              <div className="bg-fifth-color p-4 rounded-lg shadow-md mr-6">
                ...
                <p className="list-disc list-inside text-gray-600">Sistem akan memberikan notifikasi saat stok</p>
              ...
              <div className="bg-fifth-color p-4 rounded-lg shadow-md mr-6">
                ...
                <p className="list-disc list-inside text-gray-600">Pengguna dapat mengunduh berbagai jenis</p>
              ...
              <div className="bg-fifth-color p-4 rounded-lg shadow-md mr-6">
                ...
                <p className="list-disc list-inside text-gray-600">Dapat terhubung dengan sistem POS yang</p>
